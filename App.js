...
import ProductListComponent from "./app/screens/ProductListComponent";
      ...
      <NavigationContainer>
        ...
        >
          ...
          <Stack.Screen
            ...
            options={{ title: "Search/ Register Farmer", headerShown: true }}
          ></Stack.Screen>
          ...
          <Stack.Screen
            ...
            options={{ title: "Add Products", headerShown: true }}
          ></Stack.Screen>
          <Stack.Screen
            name="supplierProduct"
            component={SupplierProductScreen}
            options={{ title: "Product Weighting", headerShown: true }}
          ></Stack.Screen>
          <Stack.Screen
            name="supplierProductPreview"
            component={SupplierProductPreviewScreen}
